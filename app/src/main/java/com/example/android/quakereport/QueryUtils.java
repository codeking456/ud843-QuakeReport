...
public class QueryUtils {
    ...
    public static ArrayList<Earthquake> extractEarthquakes() {
        ...
        try {
            ...
            {
                JSONObject values= features.getJSONObject(i);
                JSONObject feature=values.getJSONObject("properties");
                double magnitude=feature.getDouble("mag");
                String location=feature.getString("place");
                long date=feature.getLong("time");
